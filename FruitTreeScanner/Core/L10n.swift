...
enum L10n {
    ...
    enum Calibration {
        ...
        static func recordTitle(treeID: String) -> String {
            String(format: recordTitleFormat, treeID)
        }

        static func deleteRecordAccessibility(treeID: String) -> String {
            String(format: deleteRecordAccessibilityFormat, treeID)
        }

        static func countAndYield(count: Int, yieldKg: Double) -> String {
            String(format: countYieldFormat, count, yieldKg)
        }

        static func countOnly(_ count: Int) -> String {
            String(format: countOnlyFormat, count)
        }

        static func yieldOnly(_ yieldKg: Double) -> String {
            String(format: yieldOnlyFormat, yieldKg)
        }
